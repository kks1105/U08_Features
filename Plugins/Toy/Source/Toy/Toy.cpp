...
void FToyModule::StartupModule()
{
	...
	//DetailPanel_Button
	{
		...
		properyEditor.RegisterCustomClassLayout(ACButtonActor::StaticClass()->GetFName(),FOnGetDetailCustomizationInstance::CreateStatic(&FDetailsButton::MakeInstance));//추가할곳넣기 클래스이름,딜리게이트
